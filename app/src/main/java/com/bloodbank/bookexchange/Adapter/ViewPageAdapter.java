...
import com.bloodbank.bookexchange.MainActivity;
import com.bloodbank.bookexchange.MessageActivity;
import com.bloodbank.bookexchange.Model.BookPost;
import com.bloodbank.bookexchange.Model.User;
import com.bloodbank.bookexchange.Pager.VerticalViewPager;
import com.bloodbank.bookexchange.PostDetailsActivity;
...
//                mProfileURL = user.getImageURL ();
       ...
       itemView.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View view) {
               ...
               intent.putExtra ( "bookName",mBookPosts.get ( position ).getBook_name () );
               intent.putExtra ( "userName",mBookPosts.get ( position ).getUsername () );
               intent.putExtra ( "time",mBookPosts.get ( position ).getTime () );
               intent.putExtra ( "date",mBookPosts.get ( position ).getDate () );
               intent.putExtra ( "profileImage",mBookPosts.get ( position ).getProfile_imageURL () );
               intent.putExtra ( "postImage",mBookPosts.get ( position ).getBook_imageURL () );
               intent.putExtra ( "description",mBookPosts.get ( position ).getBook_desc () );
               intent.putExtra ( "location",mBookPosts.get ( position ).getLocation () );
               context.startActivity ( intent );
           }
       });
