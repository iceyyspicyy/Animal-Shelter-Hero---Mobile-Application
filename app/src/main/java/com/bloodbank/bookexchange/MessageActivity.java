...
import com.bloodbank.bookexchange.Adapter.MessageAdapter;
import com.bloodbank.bookexchange.Model.Chat;
...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!bookName.equals (""))
        {
            text_send.setText ( "Hi "+userName+", I love to adopt and give a shelter to your "+bookName+" dog. Please reply back. Thank you." );
        }
